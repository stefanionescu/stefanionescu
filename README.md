...
- [gspot](https://github.com/stefanionescu/gspot) – CLI to lint and enforce rules for LLM generated codebases 
...
- [screenshot-intent-classifier](https://github.com/stefanionescu/screenshot-intent-classifier) – a demo classifier that tries to detect intent from a user to take a screenshot of a phone/desktop screen
